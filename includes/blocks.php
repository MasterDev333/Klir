...
function theme_acf_blocks_init() {
    ...
    acf_register_block_type(array(
			'name'				=> 'blog-image-caption',
			'title'				=> __('Blog Image Caption'),
			'description'		=> __('Blog Image Caption'),
      'render_callback'	=> 'theme_acf_block_render_callback',
      'render_template' => 'templates/blocks/blog-image-caption.php',
			'icon'				=> 'align-center',
			'keywords'			=> array( 'Blog Image Caption'),
      'mode' 	=> 'edit',
    ));
