...
defined( 'ABSPATH' ) || exit;
  ...
  $display_reviews = get_field('display_reviews');

  if(get_the_title() == "Klir Duo"){
    $level_up = get_product(181);
    $unwind = get_product(208);
    $display_reviews = get_field('display_reviews', 215);
    $duo = true;

  };
?>

<section class="product-breadcrumbs desktop-only test">
  <p> <a class="js-shop" href="JavaScript:void(0);">NOOTROPICS &nbsp; ></a> &nbsp;<?php echo the_title() ?></p>
</section>
    ...
    <div class="animated-border-vert js-visibility reveal-del-1 desktop-only"></div>  
      <div class="product-main__right-inner">
       ...
       <?php if($display_reviews){?>
          ...
          <?php if($product_id == '208'){?><div class="" style="margin-top: 1px"><?php echo do_shortcode('[jgm-preview-badge id=208]') ?></div> <?php } ?>
          
          
          <?php if($product_id == '181'){?><div class="" style="margin-top: 1px"><?php echo do_shortcode('[jgm-preview-badge id=181]') ?></div> <?php } ?>
          
          
          <?php if($product_id == '215'){?><div class="" style="margin-top: 1px"><?php echo do_shortcode('[jgm-preview-badge id=215]') ?></div> <?php } ?>
<?php } ?>
      ...
      <?php if ($duo) { ?>
        <div class="product-main__duo-selection">
          ...
          <?php if ($duo) { ?>
            <?php foreach( get_field( 'usp', 181 ) as $usp  ) { ?>
              <div class="product-extra__grid-item-wrap level-up-data">     
                ...
                <div class="animated-border js-visibility is-visible"></div>
                <div class="animated-border-vert js-visibility reveal-del-1 is-visible"></div>  
              </div>
            <?php } ?>
...
<div class="reviews" style=" padding-top: 13px; padding-bottom: 29px;">
...
<section class="complete-the-set ">
  ...
  <div class="complete-the-set__inner" style="padding-bottom: 20px">
    ...
    <div class="complete-the-set__right js-visibility reveal-slide reveal-del-1">
      ...
      <a href="" class="desktop-only"><h5>MORE INFORMATION</h5> </a>
              ...
              <?php _get_template_part('templates/components/_add-to-cart-form', ['product' => $product, 'id' => 'bundle-dummy-desktop']); ?>
