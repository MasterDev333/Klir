...
<div class="u-columns col2-set" id="customer_login">
	...
	<div class="u-column1 col-1 account-mods">

<?php endif; ?>



		<h2 class=""><?php //esc_html_e( 'Login', 'woocommerce' ); ?></h2>

		<h1>LOGIN</h1>
		<h4>If you need to create an account, <br> please use the link below to get started.</h4>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="woocommerce-LostPassword lost_password">
				<a href="https://klirmind.com/my-account/lost-password/"><?php esc_html_e( 'Forgot your password?', 'woocommerce' ); ?></a>
			</p>
			...
			<p class="js-create-account">Create account</p>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="u-column2 col-2 account-mods">
